...
cred = credentials.Certificate("../smartstreetparking-5038c-firebase-adminsdk-hn59r-f3e8b19c3e.json")
...
def shootphoto():
    ...
    print('photo shot, please go next step')
...
def detectphoto():
    ...
    #spots_rec = [[0.3590182363986969, 0.38978487253189087],
    #             [0.23483365774154663, 0.28582891821861267],
    #             [0.13384388387203217, 0.22422246634960175],
    #             [0.06397248432040215, 0.629776656627655],
    #             [0.8146002888679504, 0.7440712451934814],
    #             [0.5572035759687424, 0.5091916769742966],
    #             [0.04646797478199005, 0.15212662518024445]]


    #spots_rec = [[0.06415644497610629, 0.591138169169426],
    #             [0.1316215731203556, 0.2220885008573532],
    #             [0.34932272136211395, 0.38858117163181305],
    #             [0.8190532028675079, 0.7478190064430237],
    #             [0.25288843363523483, 0.287267841398716],
    #             [0.5656651854515076, 0.5105247795581818],
    #             [0.08314868807792664, 0.18649441003799438],
    #             [0.014758250152226537, 0.12134614959359169],
    #             [0.051041764207184315, 0.14491750672459602]]

    


    spots_rec = [[0.7877658605575562, 0.622300922870636],
                 [0.73779296875, 0.3827058672904968],
                 [0.5893087387084961, 0.30406615138053894],
                 [0.4768310487270355, 0.22007524222135544],
                 [0.3880382478237152, 0.15040622651576996],
                 [0.3253595530986786, 0.10638776607811451],
                 [0.25679998844861984, 0.055929506197571754],

                 #[0.24048791825771332, 0.39813023805618286],
                 [0.19478937983512878, 0.25740817934274673],
                 [0.1509048193693161, 0.20735622942447662]]
    ...
    for box, color in box_to_color_map.items():
        ...
        for item in spots_rec:
            #print(pos[0]-item[0]+pos[1]-item[1])
            sub = abs((int((pow(pos[0]-item[0],2)+pow(pos[1]-item[1],2))*1000)))
            print(sub)
            if sub<1:

                spots[spots_rec.index(item)] = 1
                print(spots)
        print(("=="))
    ...
    for item in pos_list:
        ...
        if item[1] > k*item[0]:
            print(item)
            print(pow(item[0],2)+pow(item[1],2))
    print("============================")
    for item in pos_list:
        #print(k*item[0])
        if item[1] < k*item[0]:
    ...
    print(spots)
    doc_ref = fire_db.collection('spot1')
    ...
    for doc in docs:
        dd = doc.to_dict()
        if dd['camera_id'] == 2:
            if dd['spot_id'] < number and spots[int(dd['spot_id'])] == 0:
            ...
            if scores is None:
                ...
                if not skip_labels:
                    if not agnostic_mode:
                        if (classes[i] in category_index.keys()) and (classes[i]==3 or classes[i]==8):
                            #print(classes[i])
